    ...
    <div className="relative w-full h-full bg-base-200">
      ...
      {activeItem && (
        <>
          <h2
            className={`
              select-none absolute font-black text-[3rem] left-[1.6em] top-1/2
          ...
          <p
            className={`
              select-none absolute max-w-[10ch] text-[1.2rem] top-1/2 right-[1%]
          ...
          <div
            ...
            className={`
              ...
              bg-primary border-[3px] border-primary-content rounded-full cursor-pointer
              transition-all ease-[cubic-bezier(0.25,0.1,0.25,1.0)]
              ${isMoving
            ...
            `}
          >
            <p className="select-none relative text-primary-content top-[2px] text-[26px]">&#x2197;</p>
          </div>
        </>
      )}
    </div>
